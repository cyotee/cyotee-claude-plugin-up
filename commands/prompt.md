...
- **No PROMPT.md**: "No PROMPT.md found. Are you in an agent worktree? Use /backlog:launch to create one."
...
- `/up:plan` - Read CLAUDE.md + PRD.md
- `/backlog:launch <ID>` - Create agent worktree with PROMPT.md
- `/backlog:review <ID>` - Switch PROMPT.md to review mode
