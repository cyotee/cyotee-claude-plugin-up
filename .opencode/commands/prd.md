---
description: Bootstrap context with CLAUDE.md AND read PRD.md (alias for /plan)
---

# Context Bootstrap with Project Requirements

This is an alias for `/plan`. See that command for full documentation.
